...
public class PlayerRunState : PlayerBaseState
{
    ...
    public override void UpdateState() 
    {
        ...
        //context.PlayerRb.velocity = context.transform.TransformDirection(new Vector3(context.Movement.x, 0f, context.Movement.y) * context.RunSpeed);
        Vector3 movement = context.transform.TransformDirection(new Vector3(context.Movement.x, 0f, context.Movement.y) * context.RunSpeed);
